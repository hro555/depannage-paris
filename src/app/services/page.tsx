...
export const metadata: Metadata = {
  ...
  description:
    "Remorquage, dépannage sur place, assistance accident, dépannage autoroute, transport de véhicule. Service 24h/24 à Paris et Île-de-France.",
};
      ...
      <section className="bg-dark py-16 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-lg text-white/50 max-w-3xl">
            ...
            disponibles 24h/24 dans Paris et toute l&apos;Île-de-France.
          </p>
        </div>
      </section>
