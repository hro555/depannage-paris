    ...
    <section className="py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <PhoneLink className="inline-flex items-center gap-3 bg-primary hover:bg-primary-dark text-white font-bold px-10 py-4 rounded-xl text-lg transition-colors shadow-lg shadow-primary/25 animate-pulse-slow">
